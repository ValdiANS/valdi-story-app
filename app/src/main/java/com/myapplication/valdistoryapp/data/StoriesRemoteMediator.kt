...
class StoriesRemoteMediator(
    ...
    override suspend fun load(
        ...
        return try {
            ...
            val formattedStories = responseData.listStory.map { story ->
                story.run {
                    StoryEntity(
                        id,
                        name,
            ...
            val endOfPaginationReached = formattedStories.isEmpty()
            ...
            database.withTransaction {
                ...
                database.storyDao().insertAllStories(formattedStories)
            }
